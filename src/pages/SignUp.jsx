            ...
            <div className="max-w-md mx-auto px-6 mt-16">
                <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-sm border border-gray-100 dark:border-gray-700">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">Join the community of innovators.</p>
                    </div>
                    ...
                    <p className="text-center text-gray-500 dark:text-gray-400 mt-6 text-sm">
                        ...
                        <Link to="/signin" className="text-black dark:text-white font-semibold hover:underline">
                            Sign In
                        </Link>
                    </p>
                </div>
